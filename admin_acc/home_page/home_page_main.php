...
<h2> Select Action:
<form action = "http://localhost/310-crossroads-main/admin_acc/item_delete/item_delete.html">
    <button>
        Delete An Item
    </button>
</form>
<form action = "http://localhost/310-crossroads-main/admin_acc/item_edit_desc/item_desc.html">
    <button>
        Edit Item Description
    </button>
</form>
<form action = "http://localhost/310-crossroads-main/admin_acc/item_list_insertion/item_list.html">
    <button>
        Add New Item
    </button>
</h2>
